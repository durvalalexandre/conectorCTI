...
/* Abstract syntax: CSTA_network_reached_event */
...
#ifndef OSS_CSTA_network_reached_event
#define OSS_CSTA_network_reached_event
...
#endif /* OSS_CSTA_network_reached_event */
