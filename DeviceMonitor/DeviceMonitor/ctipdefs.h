...
/* Abstract syntax: ctipdefs */
/* Created: Wed Feb 15 18:14:04 2006 */
 ...
 * -controlfile ctipdefs.c -headerfile ctipdefs.h -noshortennames -nouniquepdu
 * -externalname att_asn_tbl -noconstraints -charintegers -splitheaders
 * -compat v4.1.1 -compat v4.1.2 -compat v4.1.3 -compat v4.1.4 -compat v4.1.5
 * -compat v4.1.6 -compat v4.1.7 -compat v4.1.8
 * v:\ossasn1\win32\6.1.0\asn1dflt\asn1dflt.ms.zp8 attpriv
 */
...
#define          ATTServiceInitiatedEvent_t_PDU 95
#endif
...
#define          ATTOriginatedEvent_t_PDU 119
#endif
...
#define          ATTFailedEvent_t_PDU 137
#endif
#ifndef ATTSnapshotCallConfEvent_t_PDU
#define          ATTSnapshotCallConfEvent_t_PDU 138
#endif

extern void * const att_asn_tbl;    /* encoder-decoder control table */
