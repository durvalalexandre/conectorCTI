...
/* Created: Wed Feb 15 18:13:23 2006 */
 ...
 * -controlfile acsdefs.c -headerfile ctiacsdefs.h -noshortennames -nouniquepdu
 * -externalname acs_asn_tbl -noconstraints -compat v4.1.1 -compat v4.1.2
 * -compat v4.1.3 -compat v4.1.4 -compat v4.1.5 -compat v4.1.6 -compat v4.1.7
 * -compat v4.1.8 v:\ossasn1\win32\6.1.0\asn1dflt\asn1dflt.ms.zp8 acs
 */
...
extern void * const acs_asn_tbl;    /* encoder-decoder control table */
