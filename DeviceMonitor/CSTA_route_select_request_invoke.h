...
/* Abstract syntax: CSTA_route_select_request_invoke */
...
#ifndef OSS_CSTA_route_select_request_invoke
#define OSS_CSTA_route_select_request_invoke
...
#endif /* OSS_CSTA_route_select_request_invoke */
