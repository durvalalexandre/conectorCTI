...
/* Abstract syntax: CSTA_service_initiated_event */
...
#ifndef OSS_CSTA_service_initiated_event
#define OSS_CSTA_service_initiated_event
...
#endif /* OSS_CSTA_service_initiated_event */
